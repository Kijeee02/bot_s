...
global.called = false
global.Prefix = 'Multi'
global.ownerNumber = '6282123188567'
global.botName = 'IMPSTR - Md' 
global.owner = ['6282275639713'] 
global.ownerName = 'IMPSTR Bot'
...
global.merchant = 'M230126SEYH6139BM'
global.secret = '35032f4a1d6b735fd8cd206586998f224cb2c2dec9c824b5cc9a28b5ede9775d'
global.signature = '03ee604b94e2a97381d0473da67a7d60'
//CARA AKTIFIN:
...
const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6282123188567` } },
 ...
 *｢  BOT MENU  ｣*  	
 ...
 © ${global.packName} - ${global.ownerName}`
reply(anu)
 }
break
...
let noshp = text
if (isNaN(parseInt(noshp))) return reply(`${command} 6282123188567`)
const sections = [
    {
...
_For Your Information, Bot Hanya Mendukung Deposit Melalui Ovo, Shopeepay, Dana, Qris Saja._

_》Ovo : 085174667722_
_》Shopeepay : 085174667722_
_》Dana : 085174667722_
_》Qris : Tinggal Scan Diatas_
...
_Contoh:_
${prefix}bukti 10000|isi Saldo 6282123188567
Saldo Akan Masuk Ketika Owner Mengklik Tombol Acc Yang Dikirim Bot!.`
Manik.sendMessage(m.chat, {image : fs.readFileSync('./media/qris.jpg'), caption: depisi}, {quoted: m})
break
case prefix+'bukti':
...
let encmedia = await Manik.sendImage(global.ownerNumber+`@s.whatsapp.net`, media, `Bukti Dari: ${sender.replace("@s.whatsapp.net", "")}`, m)
let buttons = [
...
Manik.sendButtonText(global.ownerNumber+`@s.whatsapp.net`, buttons, `${bukti}`, Manik.user.name, m)
}
break
case prefix+'depoyes':
...
Manik.sendButtonText(`${siapah}`, nbuttons, `Topup Anda Berhasil Di Acc, Silahkan Melakukan TopUp Dengan Mudah Hanya Di Bot!`, Manik.user.name, m)
break
case prefix+'depono':
if (!isManik) reply(mess.owner)
...
const sections = [
    ...
    },
   {
	...
	rows: [
	    {title: "List Diamond Mobile Legends", rowId: `${prefix}mlb`}
	]
    },
   {
   	title: `Format: ${prefix}topupml2 id|server|jumlah`,
	rows: [
	    {title: "List Diamond Mobile Legends Server 2", rowId: `${prefix}mlb2`}
	]
    },
]
let isian = `    
...
_》${listml.ml.UPMYMBL12.nama} : ${listml.ml.UPMYMBL12.harga}_
_》${listml.ml.UPMYMBL28.nama} : ${listml.ml.UPMYMBL28.harga}_
_》${listml.ml.UPMYMBL42.nama} : ${listml.ml.UPMYMBL42.harga}_
_》${listml.ml.UPMYMBL70.nama} : ${listml.ml.UPMYMBL70.harga}_
_》${listml.ml.UPMYMBL112.nama} : ${listml.ml.UPMYMBL112.harga}_
_》${listml.ml.UPMYMBL140.nama} : ${listml.ml.UPMYMBL140.harga}_
_》${listml.ml.UPMYMBL284.nama} : ${listml.ml.UPMYMBL284.harga}_
_》${listml.ml.UPMYMBL355.nama} : ${listml.ml.UPMYMBL355.harga}_
...
_》${listmla.ml.ML86.nama} : ${listmla.ml.ML86.harga}_
_》${listmla.ml.ML172.nama} : ${listmla.ml.ML172.harga}_
_》${listmla.ml.ML257.nama} : ${listmla.ml.ML257.harga}_
_》${listmla.ml.ML344.nama} : ${listmla.ml.ML344.harga}_
_》${listmla.ml.ML429.nama} : ${listmla.ml.ML429.harga}_
_》${listmla.ml.ML514.nama} : ${listmla.ml.ML514.harga}_
_》${listmla.ml.ML600.nama} : ${listmla.ml.ML600.harga}_
_》${listmla.ml.ML706.nama} : ${listmla.ml.ML706.harga}_
_》${listmla.ml.ML792.nama} : ${listmla.ml.ML792.harga}_
_》${listmla.ml.ML878.nama} : ${listmla.ml.ML878.harga}_
_》${listmla.ml.ML963.nama} : ${listmla.ml.ML963.harga}_
_》${listmla.ml.ML1050.nama} : ${listmla.ml.ML1050.harga}_
_》${listmla.ml.ML1220.nama} : ${listmla.ml.ML1220.harga}_
_》${listmla.ml.ML1412.nama} : ${listmla.ml.ML1412.harga}_
_》${listmla.ml.ML2195.nama} : ${listmla.ml.ML2195.harga}_
_》${listmla.ml.ML3688.nama} : ${listmla.ml.ML3688.harga}_
_》${listmla.ml.MLWP.nama} : ${listmla.ml.MLWP.harga}_
...
break
case prefix+'mls':
if (!isManik) reply('Fitur Topup Khusus Owner, Silahkan Melakukan Transaksi Dengan Owner!')
...
if (isNaN(parseInt(prodc))) return reply(`Id Harus Berupa Angka!\n\nContoh: ${prefix}mls 23456789|2848|9288`)
if (isNaN(parseInt(prodcid))) return reply('Jumlah Harus Berupa Angka!')
let links = `https://v1.apigames.id/transaksi/http-get-v1?merchant=${global.merchant}&secret=${global.secret}&produk=ML${prodcid}&${prodcnya}&ref=AR${refer}`
...
let buttons = [
{ buttonId: prefix+`mlsy ${prodc}|${prodc2}|${prodcid}`, buttonText: { displayText: 'Lanjutkan' }, type: 1 },
]
...
let idharga = `UPMYMBL${produkid}`
if (idharga == "UPMYMBL12"){
global.hargadmml = 3179
}
if (idharga == "UPMYMBL28"){
global.hargadmml = 6358
}
if (idharga == "UPMYMBL42"){
global.hargadmml = 9540
}
if (idharga == "UPMYMBL70"){
global.hargadmml = 15900
}
if (idharga == "UPMYMBL112"){
global.hargadmml = 25440
}
if (idharga == "UPMYMBL140"){
global.hargadmml = 31800
    }
if (idharga == "UPMYMBL284"){
global.hargadmml = 63600
    }
if (idharga == "UPMYMBL355"){
global.hargadmml = 79500
    }
...
if(response.data.data.status == "Sukses"){
if (idharga == "UPMYMBL12"){
moneyAdd(m.sender, 3179)
reply(workid)
}
if (idharga == "UPMYMBL28"){
moneyAdd(m.sender, 6358)
reply(workid)
}
if (idharga == "UPMYMBL42"){
moneyAdd(m.sender, 9540)
reply(workid)
}
if (idharga == "UPMYMBL70"){
moneyAdd(m.sender, 15900)
reply(workid)
}
if (idharga == "UPMYMBL112"){
moneyAdd(m.sender, 25440)
reply(workid)
}
if (idharga == "UPMYMBL140"){
moneyAdd(m.sender, 31800)
reply(workid)
}
if (idharga == "UPMYMBL284"){
moneyAdd(m.sender, 63600)
reply(workid)
}
if (idharga == "UPMYMBL355"){
moneyAdd(m.sender, 79500)
reply(workid)
}
} else if(response.data.data.status == "Gagal"){
reply(workd)
...
axios.get(`https://api.lolhuman.xyz/api/freefire/${idff}?apikey=${lolkey}`)
            .then(({data}) => {
reply('Tunggu Sebentar Kak, Bot Akan Cek Id Kakak😊')
            })
            .catch((err) => {
...
🔗 *Media Url* : ${images}`,
	    ...
	    if (!text) return m.reply(`Example : ${command} story wa anime`)
                ...
                Manik.sendMessage(from, {image: {url: anu.thumbnail}, caption: `⊳ Title : ${anu.title}\n⊳ ID : ${anu.videoId}\n⊳ Duration : ${anu.timestamp}\n⊳ Viewers : ${anu.views}\n⊳ Upload At : ${anu.ago}\n⊳ Author : ${anu.author.name}\n⊳ Channel : ${anu.author.url}\n⊳ Description : ${anu.description}\n⊳ Url : ${anu.url}\n\nUntuk lagu ketik ${prefix}ytmp3\nUntuk video ketik ${prefix}ytmp4\nContoh :\n${prefix}ytmp3 ${anu.url}`}, { quoted: m })
      	      }
      	      break
	    case prefix+'ytmp3': case prefix+'yta':{
				addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return m.reply(`Example : ${command} https://youtu.be/C1axHEk5s9w`)
                m.reply(`Tunggu sebentar....`)
                let res = await fetchJson(`https://pnggilajacn.my.id/api/download/ytmp3?url=`+text)
                let size = res.result.size
                if (size >= 100000) return m.reply(`*File melebihi batas, download sendiri.!!* ☠️\n\nLink: ${res.result.download}`)
                Manik.sendMessage(from, { audio: { url: res.result.download }, mimetype: 'audio/mpeg', fileName: `${res.result.title}.mp3` }, { quoted: m })
       	     }
        	    break
            case prefix+'ytmp4': case prefix+'ytv':{
				addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return m.reply(`Example : ${command} https://youtu.be/C1axHEk5s9w`)
                m.reply(`Tunggu sebentar....`)
                let res = await fetchJson(`https://pnggilajacn.my.id/api/download/ytmp4?url=`+text)
                let size = res.result.size
                if (size >= 100000) return m.reply(`*File melebihi batas, download sendiri.!!* ☠️\n\nLink: ${res.result.download}`)
                Manik.sendMessage(from, { video: { url: res.result.download }, mimetype: 'video/mp4', fileName: `${res.result.title}.mp4`, caption: `Title : ${res.result.title}\nFile Size : ${size}\nUrl : ${isUrl(text)}\nExt : MP3\nResolusi : 360p` }, { quoted: m })
        	    }
        	    break
...
reply('*Join To Group Official Bot : https://chat.whatsapp.com/CEgt0SzvidH2UoZ5s70Z2k*')
break
...
break
	    ...
	    case prefix+'anonymous':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                ...
                m.reply(`Halo ${pushname}👋, berikut perintah anonymous chat bot
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            break
            case prefix+'author': case prefix+'owner': case prefix+'creator':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
    ...
    + 'FN:Kijeee\n'
    + 'ORG:Kijeee;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6282123188567:+62 851-7466-7722\n' 
    + 'item1.X-ABLabel:Creator ZannBott\n'
    + 'item2.EMAIL;type=INTERNET:putuanantasaputra1567@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/adminzannstore\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Manik.sendMessage(m.chat, { contacts: { displayName: 'Kijeee', contacts: [{ vcard }] } }, { quoted: m })
            }
            break            
                    case prefix+'bug': case prefix+'report':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                    	if(!text) return reply `Enter The Bug Example\n\n${command.slice(1)} Menu Error `
                    	Manik.sendMessage(global.ownerNumber + `@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              if (!text) reply `Example : ${prefix + command} black rover`
              reply('Tunggu Ya Kakak😊, Bot Carikan')
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
       ...
       addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              reply('Tunggu Ya Kak??, Bot Carikan')
...
if (!isPremium && global.db.users[m.sender].limit < 1) return reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command.slice(1)}?apikey=${lolkey}`)
    Manik.sendImage(m.chat, buff, `ZannBot By Kijeee`, m)
break
...
break
case prefix+'checklimit': case prefix+'ceklimit': 
...
const sendMsg = await Manik.sendMessage(m.chat, listMessage)
        ...
        case prefix+'proses':
            ...
            m.quoted.copyNForward(global.ownerNumber+`@s.whatsapp.net`, true)
            Manik.sendMessage(global.ownerNumber+`@s.whatsapp.net`, {text: proses })
            break
        case prefix+'done':
            if (!isManik) return
